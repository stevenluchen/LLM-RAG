...
if __name__ == "__main__":
    ...
    elif model_name == "rag_updated":
        from rag_updated import RAGModel_updated
        model = RAGModel_updated(llm_name=llm_name, is_server=args.is_server, vllm_server=args.vllm_server)
    else:
